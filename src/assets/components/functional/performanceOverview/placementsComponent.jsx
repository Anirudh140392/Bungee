...
const PlacementsComponent = () => {
    ...
    const selectedBrand = searchParams.get("brand") || "bunge Cosmetics";
    ...
    const getPlacementData = async (forceRefresh = false) => {
        ...
        let url = `https://react-api-script.onrender.com/bunge/placement?start_date=${startDate}&end_date=${endDate}&platform=${operator}${ts}`;
