...
const SmartControlDatatable = () => {
  ...
  const getRulesData = async (forceRefresh = false) => {
    ...
    try {
      const response = await fetch(
        `https://react-api-script.onrender.com/bunge/displayrules?platform=${operator}`,
        {
          method: "GET",
          headers: {
  ...
  const toggleRuleStatus = async (ruleId, currentStatus) => {
    ...
    try {
      const response = await fetch(
        `https://react-api-script.onrender.com/bunge/play-pause-rule?rule_id=${ruleId}&platform=${operator}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteRule = async (ruleId, status) => {
    ...
    try {
      const response = await fetch(
        `https://react-api-script.onrender.com/bunge/delete-rule?rule_id=${ruleId}&platform=${operator}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
