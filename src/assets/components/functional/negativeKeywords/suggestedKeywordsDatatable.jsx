...
const SuggestedKeywordsDatatable = () => {
    ...
    const getKeywordsData = async () => {
        ...
        try {
            const url = `https://react-api-script.onrender.com/bunge/suggested-negative-keyword?start_date=${startDate}&end_date=${endDate}&platform=${operator}`;
    ...
    const handleAddNegativeKeyword = async (row) => {
       ...
       try {
    const url = `https://react-api-script.onrender.com/bunge/add-negative-keyword`;
