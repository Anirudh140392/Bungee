    ...
    useEffect(() => {
        const fetchWalletBalance = async () => {
            try {
                ...
                let url = `https://react-api-script.onrender.com/bunge/wallet_balance?platform=${operatorName}`;
                if (selectedBrand) {
                ...
                <div className="redirection-navbar-con">
                    <Accordion className="navbar-accordion">
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Body>
                                {["Blinkit","Amazon","Zepto","Flipkart","BigBasket"].includes(operatorName) && (
                                    <RedirectLink
                                ...
                                {["Amazon","Zepto","BigBasket","Blinkit","Flipkart"].includes(operatorName) && (
                                    <RedirectLink
                                ...
                                {!["Blinkit","Amazon","Zepto","Flipkart"].includes(operatorName) && (
                                    <RedirectLink
